...
class VocabSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $records = [
            ...
            ["user_id" => "1","title"=>"To take an early retirement","last_seen" => $created_at,"last_status" => "new","repeat_number" => "0", "created_at" => $created_at],
            ["user_id" => "1","title"=>"Demanding job","last_seen" => $created_at,"last_status" => "new","repeat_number" => "0", "created_at" => $created_at],
            ["user_id" => "1","title"=>"Hand over fist","last_seen" => $created_at,"last_status" => "new","repeat_number" => "0", "created_at" => $created_at],
            ["user_id" => "1","title"=>"A cashless society","last_seen" => $created_at,"last_status" => "new","repeat_number" => "0", "created_at" => $created_at],
            ["user_id" => "1","title"=>"Fraud","last_seen" => $created_at,"last_status" => "new","repeat_number" => "0", "created_at" => $created_at],
            ["user_id" => "1","title"=>"Under the table","last_seen" => $created_at,"last_status" => "new","repeat_number" => "0", "created_at" => $created_at],
