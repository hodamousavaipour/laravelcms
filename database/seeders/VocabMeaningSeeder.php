...
class VocabMeaningSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $records = [
            ...
            ["vocab_id" => "7","type"=>"noun","meaning" => "an official examination of business and financial records to see that they are true and correct","sample" => "an annual audit"],
            ["vocab_id" => "8","type"=>"noun","meaning" => "an official rule made by a government or some other authority","sample" => "the strict regulations government the sale of weapons."],
            ["vocab_id" => "8","type"=>"adjective","meaning" => "that must be worn or used according to the official rules.","sample" => "in regulaton uniform."],
        ];
